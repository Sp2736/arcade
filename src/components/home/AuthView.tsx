  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        department: dept,
        role,
        targetRole: role === "student" && targetRole.trim() !== "" ? targetRole.trim() : null,
        designation: (role === "faculty" || role === "admin") && designation.trim() !== "" ? designation.trim() : null,
        cabinLocation: (role === "faculty" || role === "admin") && cabin.trim() !== "" ? cabin.trim() : null,
        password,
