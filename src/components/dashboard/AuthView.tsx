...
import { Mail, Lock, User, IdCard, Building2, ChevronRight, ArrowRight, GraduationCap, KeyRound, AlertCircle, Eye, EyeOff } from "lucide-react";
      ...
      */}
      <div className="hidden md:flex w-[45%] lg:w-[40%] h-full bg-zinc-900/30 backdrop-blur-xl relative flex-col justify-between p-12 overflow-hidden border-r border-white/10 shrink-0">
        ...
        <div className="relative z-10">
            <h2 className="text-xl font-black tracking-[0.2em] text-white mb-2">A.R.C.A.D.E.</h2>
        ...
        <div className="w-full max-w-md px-8 py-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-zinc-400 text-sm">
                    {mode === "login" ? "Enter your credentials to access the portal." : "Fill in your details to register."}
                </p>
            </div>
            ...
            <div className="flex gap-6 mb-6 border-b border-white/10">
                ...
                >
                    Login
                    {mode === "login" && <motion.div layoutId="tab-underline" className="absolute bottom-[-1px] left-0 w-full h-[2px] bg-blue-500" />}
                </button>
                <button 
                ...
                >
                    Sign Up
                    {mode === "signup" && <motion.div layoutId="tab-underline" className="absolute bottom-[-1px] left-0 w-full h-[2px] bg-blue-500" />}
                </button>
            </div>
...
function LoginForm() {
    return (
        ...
        >
            <InputGroup label="Email" icon={Mail} type="email" placeholder="Enter College Email" />
            <InputGroup label="Password" icon={Lock} type="password" placeholder="Enter Password" isPassword />
    ...
    return (
        ...
        >
            <div className="grid grid-cols-2 gap-3">
                <InputGroup label="Full Name" icon={User} type="text" placeholder="Enter Name" />
                <InputGroup label="College ID" icon={IdCard} type="text" placeholder="Official ID" />
            </div>

            <InputGroup label="College Email" icon={Mail} type="email" placeholder="Official Email" />
            <InputGroup label="Personal Email" icon={Mail} type="email" placeholder="Backup Email" />

            <div className="grid grid-cols-2 gap-3">
                <SelectGroup label="Department" icon={Building2}>
                ...
                <SelectGroup label="Role" icon={GraduationCap} onChange={(e: any) => setRole(e.target.value)} value={role}>
            ...
            <InputGroup label="Password" icon={Lock} type="password" placeholder="Create Password" isPassword />
...
const InputGroup = ({ label, icon: Icon, type, placeholder, isPassword, noMargin }: any) => {
